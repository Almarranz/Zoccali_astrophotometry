...
np.savetxt(tmp+'GNS_commons_w_Zoc_c%s'%(chip),gns_txt,header='a ,d , m, dm, f, df,x,y,dx,dy. X and Y are the correspondig coorinates wit GNS, They are not the original ones!!!!')
