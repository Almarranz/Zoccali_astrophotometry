...
EXTAST, header, astr 
 ...
 ;~ ; ------------------------------
    ...
    if lst gt 5 then begin
		...
		forprint, TEXTOUT= '/Users/amartinez/Desktop/PhD/python/Gaussian_fit/'+name1+'_aa_IDL_arcsec_vx_vy_chip'+strn(chip)+'.txt',x_dis,y_dis,dvx,dvy,mH,m,a,d,raH,decH,format='(10(f, 4X))', /NOCOMMENT
    endelse
