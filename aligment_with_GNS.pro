...
EXTAST, header, astr 
 ...
 ;~ ; ------------------------------
    ...
    forprint, TEXTOUT= '/Users/amartinez/Desktop/PhD/HAWK/The_Brick/photometry/dxy_GNS_vs_ZOC/'+'in'+strn(name1)+'_comm_GNS_ZOC.txt',mH,dx,dy,draH,ddecH,format='(5(f, 10X))',/NOCOMMENT 
    ...
    if lst gt 5 then begin
		...
		forprint, TEXTOUT= '/Users/amartinez/Desktop/PhD/python/Gaussian_fit/'+name1+'_aa_IDL_arcsec_vx_vy_chip'+strn(chip)+'.txt',x_dis,y_dis,dvx,dvy,mH,mK,m,a,d,raH,decH,format='(11(f, 4X))', /NOCOMMENT
    endelse
